...
<body>
	<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 链接中心 <span class="c-gray en">&gt;</span> 修改产品信息 <a class="btn btn-success radius r mr-20" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
	<div class="pd-20">
	<form action="link-action.php?operate=update" method="post" class="form form-horizontal" id="form-article-add" enctype="multipart/form-data">
		<div class="row cl">
		<input type="hidden" name="id" value="<?php echo $rows['id'] ;?>"/>
			<label class="form-label col-2"><span class="c-red">*</span>链接标题：</label>
			<div class="formControls col-10">
				<input type="text" class="input-text" value="<?php echo $rows['name'];  ?>" placeholder="" id="" name="name">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-10">
				<input type="text" name="http" id="" placeholder="" value="<?php echo $rows['http']; ?>" class="input-text">
			</div>
		</div>
		...
		<div class="row cl">
			<label class="form-label col-2">链接状态：</label>
			<div class="formControls col-10">
				 <div class="radio-box">
		...
		<div class="row cl">
			<label class="form-label col-2">链接描述：</label>
			<div class="formControls col-10"> 
				<script id="editor" name="descr" value="<?php echo $rows['descr'] ?>" type="text/plain" style="width:100%;height:400px;"><?php echo $rows['descr'] ?></script> 
			</div>
		</div>
		<div class="row cl">
			<div class="col-10 col-offset-2">
				...
				<button onclick="javascript:location.href='link-list.php';" class="btn btn-default radius" type="button">&nbsp;&nbsp;取消&nbsp;&nbsp;</button>
			</div>
		</div>
	</form>
</div>
