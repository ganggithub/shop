		...
		<tbody>
			<?php 
				...
				echo "<td><input type='checkbox' value='1' name=''></td>";
						...
						echo "<a style='padding-left:10px;' href='member-list.php?p=1{$search}'>首页</a>";
						echo "<a style='padding-left:10px;'  href='member-list.php?p=".($currentpage-1)."{$search}'>上一页</a>";
						echo "<a style='padding-left:10px;'  href='member-list.php?p=".($currentpage+1)."{$search}'>下一页</a>";
						echo "<a style='padding-left:10px;'   href='member-list.php?p={$pagenum}{$search}'>尾页<a/>";
						echo "</td></tr>";
