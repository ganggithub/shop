...
<html>
	...
	<body>
		...
		<?php
			...
			$sqlud="select * from address where state=1 and uid={$uid}";
			$resud=mysql_query($sqlud);
			$rowud=mysql_fetch_assoc($resud);
					...
					<div class="aressinfo">
						...
						<div class="addaress clear">
								...
								<dl class="address_pop">
									...
									<dd>
										<i class="needicon">*</i>
										<input type="text" class="text" name="code" value="<?php  echo $rowud['code']; ?>"/>
									</dd>
									
									<dt>详细地址：</dt>
									<dd>
										<i class="needicon">*</i>
										<textarea rows="3" name="address" cols="30" value="<?php echo $rowud['address'] ?>" class="textarea"><?php echo $rowud['address'] ?></textarea>
									</dd>
									<dt>收货人姓名：</dt>
									<dd>
										<i class="needicon">*</i>
										<input type="text" value="<?php echo $rowud['linkman']; ?>" class="text" value="" name="linkman"/>
									</dd>
									<dt>手机：</dt>
									<dd>
										<i class="needicon">*</i>
										<input type="text" class="text" value="<?php echo $rowud['phone']; ?>" name="phone"/>
									</dd>
