...
<html>
		...
		<div class="orderbody clear">
			<div class="center">
				...
				<div class="orderright">
					<div class="odsearch" style=""><form action="dshorder.php" method='get'>
	<div class="text-c"> 
	...
	*/
	...
	$pagenum=ceil($totalpage/$pagesize);//总共有多少页	
			...
			<td>
			<a title="查看详情订单" href="ordertail.php?id=<?php echo $row3['id']; ?>&status=<?php echo $status; ?>" class="ml-5" style="text-decoration:none;display: block;" >查看详情</a> 
			...
			<?php
					...
					echo "<tr><td colspan='11' align='right' style='width:100%;text-align:right;'>";
						...
						echo "<a style='padding-left:10px;' href='dshorder.php?p=1{$search}'>首页</a>";
						echo "<a style='padding-left:10px;' href='dshorder.php?p=".($currentpage-1)."{$search}'>上一页</a>";
						echo "<a style='padding-left:10px;' href='dshorder.php?p=".($currentpage+1)."{$search}'>下一页</a>";
						echo "<a style='padding-left:10px;' href='dshorder.php?p={$pagenum}{$search}'>尾页<a/>";
						echo "</td></tr>";		
				}}
			?>
		</tbody>
